...
public class Main {
    public static void main(String[] args) {
        String input ="Классический текст Lorem Ipsum, используемый с XVI века\n" +
        ...
        Collections.sort(list, new Comparator<String>() {
            public int compare(String o1, String o2) {
                return hMap.get(o1) - hMap.get(o2);
            }
        });

        for(String item:list) {
            printer(item,hMap.get(item));
        }
    }

    private static void printer(String item, int value) {
